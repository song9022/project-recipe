...
//   // const fetchNickname = (url) => {
//   //   if (userData !== "") {
//   //     console.log(`${userData._links.self.href}`)
//   //     url = `${userData._links.self.href}`;
//   //     console.log(url);
...
//           )}
//           {isEditing ? (
//             <SaveButton onClick={saveNickname(url)}>저장</SaveButton>
//           ) : (
