...
export default function Write ({ userData }) {
  ...
  const url = (!userData || !userData._links || !userData._links.self ||
    !userData._links.self.href) ? alert("유효한 userData._links.self.href가 없습니다.") : userData._links.self.href

  // const url = userData._links.self.href;
  console.log("URL:", url);
  console.log(typeof(url))
  const purl = Number(url)
  console.log(typeof(purl))
