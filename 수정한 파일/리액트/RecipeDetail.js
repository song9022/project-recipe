...
const RecipeDetail = ({ userData }) => {
  ...
  const fetchRecipeUser = async () => {
    try {
      const response = await fetch(`http://localhost:8024/api/recipes/${id}/user`, {
  ...
  const userRecipes = () => {
    ...
    fetch(`http://localhost:8024/api/users/2`, {
    // fetch(userData._links.self.herf, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  //       axios.get(`http://localhost:8024/api/recipes/${id}/comments`)
  //         .then(response => {
  ...
  //     try {
  //       const response = await fetch(`http://localhost:8024/api/comments/${editingCommentId}`, {
  //         method: 'PUT',
  //         headers: {
  //           'Content-Type': 'application/json',
  //         },
  ...
  //     try {
  //       const response = await fetch(`http://localhost:8024/api/comments/recipe/${id}`, {
  //         method: 'POST',
  //         headers: {
  //           'Content-Type': 'application/json',
  //         },
